 ...
 */
public class DecentralizedUUIDFunctions implements JSLTFunctions {

  @Override
  public JSLTNamespace getNamespace() throws URISyntaxException {
    return new JSLTNamespace("d-uuid",new URI("http://jslt.schibsted.com/2018/decentralized-uuid"));
  }
  ...
  public Map<String, Function> functions() {
      ...
      functions.put("new", new DecentralizedUUIDFunctions.New());
      return functions;
  }
  ...
  public static class New extends AbstractFunction {
    ...
    public JsonNode call(JsonNode input, JsonNode[] arguments) {
      return new TextNode(getBase64UUID());
    }
